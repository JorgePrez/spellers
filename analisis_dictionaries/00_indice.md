# Diccionario medico UA + spellcheck EC2 ù Indice
...
**Estado al 24/07/2026:** Medicina **v2.3.0** (~125k). Odontologia **v1.0.0** (~6.5k). Derecho **v1.0.0** (~5.4k). Ortografia prioritaria. Plan en `09_`. Referencias en `10_`.
