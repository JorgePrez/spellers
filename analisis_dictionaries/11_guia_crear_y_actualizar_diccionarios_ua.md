...
| Área | Carpeta | Id extensión | Tamaño (aprox.) |
|------|---------|--------------|-----------------|
| Medicina | `dictionaries/dict-ua-med/` | `org.ua.dictionaries.med-gt` | ~125455 (v2.3.0) |
| Odontología | `dictionaries/dict-ua-odo/` | `org.ua.dictionaries.odo-gt` | ~47198 (v1.1.0) |
| Derecho | `dictionaries/dict-ua-der/` | `org.ua.dictionaries.der-gt` | ~59181 (v1.2.0) |
| Ciencias económicas | `dictionaries/dict-ua-eco/` | `org.ua.dictionaries.eco-gt` | ~40065 (v1.1.0) |
| Arquitectura | `dictionaries/dict-ua-arq/` | `org.ua.dictionaries.arq-gt` | ~46761 (v1.1.0) |
| Estudios políticos | `dictionaries/dict-ua-pol/` | `org.ua.dictionaries.pol-gt` | ~40380 (v1.1.0) |
| Psicología | `dictionaries/dict-ua-psi/` | `org.ua.dictionaries.psi-gt` | ~38236 (v1.1.0) |
| Universitario (ES) | `dictionaries/dict-ua-uni/` | `org.ua.dictionaries.uni-gt` | ~35210 (v1.1.0) |
| Anglicismos campus | `dictionaries/dict-ua-ang/` | `org.ua.dictionaries.ang-gt` | ~12499 (v1.1.0; `ortho_ang`) |

Inventario y instalación conjunta: [`../dictionaries/README.md`](../dictionaries/README.md).
...
```
python gen_expand_<area>.py
    -> source/external/expanded_<area>.txt
       (morph raíz×sufijo + harvest es_GT/es_ES + seeds)
       + ortho_priority (o ortho_ang si ang)

bloques curados (gen_lexicon*.py)
    + morfología de área (gen_morph.py)
    + expanded_<area>.txt
    + harvest es_* (marcadores de dominio)
    + plurales / Title Case puntual
        |
        v
ortho_priority.py   <-- OBLIGATORIO (excepto ang -> ortho_ang)
        |
        v
ua_<area>_GT.dic + verify_dic.py
```

Motor compartido: `dictionaries/_shared/expand_engine.py`.
Referencias de consulta (no volcado): `10_referencias_diccionarios_por_facultad.md`.
